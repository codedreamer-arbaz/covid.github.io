...
<div class="leftside w-100 h-100 d-flex justify-content-center align-items-center">
    <img src="images/coron.png" width="300" height="300">
</div>
</div>
<div class="col-lg-7 col-md-7 col-12 order-lg-2 order-1">
    <div class="rightside w-100 h-100 d-flex justify-content-center align-items-center">
    <h1>Let's Stay Safe & Fight Together Against Cor <span class="corona_rot"><img src="images/coron1.png" width="65" height="65"></span> na Virus</h1>
...
<div class="container-fluid sub_section pt-5 pb-5 " id="aboutid">
    ...
    <div class="row pt-5">
        <div class="col-lg-5 col-md-6 col-12 ml-5 about_res">
            <img src="images/novel.jpg" class="img-fluid">
        </div>
        <div class="col-lg-6 col-md-6 col-12">
            <h2>What is COVID-19 (Corona-Virus)</h2>
            <p>COVID-19 is the infectious disease caused by the most recently discovered coronavirus. This new virus and dieases were unknown before the outbreak began in Wuhan, Chaina, in December 2019.</p>
            <p>Coronaviruses are a large family of viruses which may couse illness in animals or humans. In humans, several coronaviruses are known to cause repiratory infections ranging from the common cold to more severe diseses such as Middle East Respiratory Syndrom (MERS) and Severe Acute Respiratory Syndrome (SARS). The most recently discovered coronavirus causes coronavirus dieses COVID-19.</p>
        </div>
    </div>
</div>
<!-- /////////////////////Corona Symtoms////////-->
<div class="container-fluid pt-5 pb-5 " id="sympid">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-12 mt-5">
            <figure class="text-center">
            <img src="images/tierdness.jpg" class="img-fluid" width="120" height="120">
            <figcaption>tiredness</figcaption>
            </figure>
        </div>
        <div class="col-lg-4 col-md-4 col-12 mt-5">
            <figure class="text-center">
            <img src="images/difficulty.jpg" class="img-fluid" width="120" height="120">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12 mt-5">
                ...
                <figure>
                <img src="images/wash.jpg" class="img-fluid" width="90" height="90">
                </figure>
                </div>
                <div class="col-lg-8 col-md-8 col-12">
                <p>Wash Your hands regularly for 20 seconds, with soap and water or sanitizer's.</p>
                </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-12 mt-5">
                ...
                <div class="col-lg-8 col-md-8 col-12">
                <p>Cover your nose and mouth with a disposable tissue or flexed elebow when you cough or sneeze.</p>
                </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-12 mt-5">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                <figure class="text-center">
                <img src="images/feverr.jpg" class="img-fluid" width="90" height="90">
                </figure>
                </div>
                <div class="col-lg-8 col-md-8 col-12">
                <p>If you have fever,cough and difficulty in breathing seek for medical care early.</p>
                </div>
                </div>
            </div>
